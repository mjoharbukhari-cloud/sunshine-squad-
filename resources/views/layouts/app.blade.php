  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      ...
      <form class="d-flex" method="GET" action="/search">
        <input class="form-control me-2" type="search" name="q" placeholder="Search products, deals">
...
{{-- MAIN CONTENT: updated to support sidebar on profile pages --}}
...
<footer class="footer-elite mt-5 pt-5">
  <div class="container">
    ...
    <div class="d-flex justify-content-between pb-4">
      <small>© 2025 Sunshine Squad. All rights reserved.</small>
